    ...
    public function ajax(): JsonResponse
    {
        ...
        return datatables()
            ...
            ->addColumn('name', function ($pages) {
                ...
                $str = '';
                if (auth()->user()?->hasPermission('Modules\CMS\Http\Controllers\CMSController@edit')) {
                    $str .= $edit;
                }
                $str .= $view;
                if (auth()->user()?->hasPermission('Modules\CMS\Http\Controllers\CMSController@delete')) {
                    $str .= $delete;
                }
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->addColumn([
                ...
                'visible' => auth()->user()?->hasAnyPermission(['Modules\CMS\Http\Controllers\CMSController@edit', 'Modules\CMS\Http\Controllers\CMSController@delete']),
