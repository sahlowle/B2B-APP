    ...
    <div class="col-sm-12 list-container">
        <div class="card">
            <div class="card-header d-md-flex justify-content-between align-items-center">
                <div>
                    <h5>
                        ...
                        >>
                        <a href="javascript:void();">{{ $page->getTranslated('name', request()->input('lang', config('app.locale'))) }}</a>

                    </h5>
                </div>
                <div class="d-flex justify-content-end align-items-center w-25 h-0">
            ...
            <div class="card-body px-4 pb-0">
                <div class="card-block pt-2 px-0 pb-0">
            ...
            <div class="card-footer py-3 d-flex justify-content-end">
                <div class="form-group d-flex mb-0">
                    <button class="btn btn-primary btn-sm has-spinner-loader mb-0" id="update_page" type="submit"><i
                            class="feather icon-save ltr:me-1 rtl:ms-1"></i>{{ __('Save') }}
                    </button>
                </div>
                <div class="form-group d-flex mb-0">
                    <a class="btn btn-sm btn-primary mb-0" href="{{ route('site.page', $page->slug) }}" target="_blank"><i
...
@section('js')
    ...
    <script>
        ...
        const langUrl = '{{ route('builder.edit', $page->slug) }}';
    </script>

    <script src="{{ asset('public/dist/js/xss.min.js') }}"></script>
    <script src="{{ asset('Modules/CMS/Resources/assets/js/builder.min.js?v=2.4') }}"></script>
