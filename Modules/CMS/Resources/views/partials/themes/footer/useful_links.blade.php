    ...
    <div class="card-body px-0 px-md-4">
        <div class="form-group row my-0">
            ...
            <div class="col-sm-9 input-group bg-transparent">
                <input type="text" class="form-control widget-title inputFieldDesign" name="{{ $layout }}_template_footer[main][useful_links][title]" value="{{ isset($footer['main']['useful_links']['title']) ? $footer['main']['useful_links']['title'] : '' }}" maxlength="40">
            </div>
        </div>
        <hr>
        ...
        @php
            $data = isset($footer['main']['useful_links']['data']) && !empty($footer['main']['useful_links']['data']) ? $footer['main']['useful_links']['data'] : [];
        @endphp
