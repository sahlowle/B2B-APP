        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-right d-inline-block">
                    @hasPermission('Modules\CMS\Http\Controllers\SliderController@store')
                                ...
                                <div class="card Design-sprint theme-bg1 box-shadow-unset border">
                                    <div class="card-header borderless pb-0">
                                        ...
                                        <div class="card-header-right">
                                            @hasPermission('Modules\CMS\Http\Controllers\SliderController@update')
                                            ...
                                            @endhasPermission
                                            @hasPermission('Modules\CMS\Http\Controllers\SliderController@delete')
                                                <form method="post"
