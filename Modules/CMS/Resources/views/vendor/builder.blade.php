    ...
    <div class="col-sm-12 list-container">
        <div class="card">
            ...
            <div class="card-footer py-3 d-flex justify-content-end">
                ...
                <div class="form-group d-flex mb-0">
                    <a class="btn btn-sm btn-primary mb-0" href="{{ route('site.shop', ['alias' => auth()->user()?->shop()?->alias ?? 'unknown', 'homepage' => $page->slug]) }}" target="_blank"><i
...
@section('js')
    ...
    <script>
        ...
        const langUrl = '{{ route('vendor.builder.edit', $page->slug) }}';
    </script>
