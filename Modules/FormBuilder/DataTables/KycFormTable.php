    ...
    public function ajax(): JsonResponse
    {
        ...
        return datatables()
            ...
            ->editColumn('username', function ($sub) {
                ...
                $edit = '<a title="' . __('Edit :x', ['x' => __('Submission')]) . '" href="' . route('formbuilder::kyc.sub-edit', [$sub->id]) . '" class="action-icon"><i class="feather icon-edit-1" aria-hidden="true"></i></a>&nbsp';
