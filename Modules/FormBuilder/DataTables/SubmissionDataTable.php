    ...
    public function ajax(): JsonResponse
    {
        ...
        return datatables()
            ...
            ->editColumn('username', function ($sub) {
                ...
                $edit = '<a title="' . __('Edit :x', ['x' => __('Submission')]) . '" href="' . route('formbuilder::entry.edit', [$sub->id]) . '" class="action-icon pr-5"><i class="feather icon-edit-1" aria-hidden="true"></i></a>&nbsp';
