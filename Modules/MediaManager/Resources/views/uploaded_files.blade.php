    ...
    <div class="col-sm-12" id="media-manager-container">
        <div class="card">
            <div class="card-header d-md-flex justify-content-between align-items-center">
                ...
                @hasPermission('Modules\MediaManager\Http\Controllers\MediaManagerController@create')
                                    ...
                                    <div class="px-3">
                                        <div class="thumb-{{ $file->id }}" id="modal-img-des-container">
                                            <div>
                                                ...
                                                <video class="media-manager-image img-fluid img-thumbnail p-0 mb-1 image-id" controls>
