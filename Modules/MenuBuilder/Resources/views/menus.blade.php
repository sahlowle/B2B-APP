    ...
    <dl class="menu-item-bar" id="{{ $m->id }}">
        <dt class="menu-item-handle">
            <span class="item-title"><i class="feather feather icon-move"></i> <span class="menu-item-title"> <span
                        id="menutitletemp_{{ $m->id }}">{{ $m->getTranslated('label', $selectedLang) }}</span>
        ...
        <p class="description description-thin">
            <label
                ...
                <input type="text"
                    ...
                    value="{{ $m->getTranslated('label', $selectedLang) }}">
            </label>
        </p>
        ...
        <p class="field-css-classes description description-thin">
            <label for="edit-menu-item-icon-{{ $m->id }}">
                ...
                <input type="text"
                    ...
                    class="form-control edit-menu-item-icon custom-input-field"
