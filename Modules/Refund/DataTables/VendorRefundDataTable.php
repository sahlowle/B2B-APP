    ...
    public function ajax(): JsonResponse
    {
        ...
        return datatables()
            ...
            ->editColumn('status', function ($refunds) {
                ...
                $str = '';
                if (auth()->user()?->hasPermission('Modules\Refund\Http\Controllers\Vendor\RefundController@edit')) {
                    $str .= $edit;
                }
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->addColumn(['data' => 'action', 'name' => 'action', 'title' => '', 'width' => '5%',
                'visible' => auth()->user()?->hasAnyPermission(['Modules\Refund\Http\Controllers\Vendor\RefundController@edit']),
