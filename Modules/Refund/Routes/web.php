...
Route::group(['prefix' => 'myaccount', 'namespace' => 'Modules\Refund\Http\Controllers\Site', 'middleware' => ['site.auth', 'locale', 'permission', 'web']], function () {
    // User Refund
    Route::get('refunds', 'RefundController@index')->name('site.refundRequest')->middleware('themeable');
    Route::get('refunds/create', 'RefundController@createRequest')->name('site.createRefundRequest')->middleware('themeable');
    Route::post('refunds', 'RefundController@refund')->name('site.orderRefund');
    Route::get('refunds/{id}', 'RefundController@refundDetails')->name('site.refundDetails')->middleware('themeable');
