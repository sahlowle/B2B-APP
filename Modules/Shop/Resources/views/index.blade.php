...
<script type="text/javascript">
    'use strict';
    var pdf = "{{ (auth()->user()?->hasPermission('Modules\Shop\Http\Controllers\ShopController@pdf')) ? '1' : '0' }}";
    var csv = "{{ (auth()->user()?->hasPermission('Modules\Shop\Http\Controllers\ShopController@csv')) ? '1' : '0' }}";
</script>
