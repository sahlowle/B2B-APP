    ...
    public function ajax(): JsonResponse
    {
        ...
        return datatables()
            ...
            ->addColumn('action', function ($notifications) {
                ...
                $str = '';
                if (auth()->user()?->hasPermission('App\Http\Controllers\NotificationController@markAsRead')) {
                    $str .= $mark;
                }

                if (auth()->user()?->hasPermission('App\Http\Controllers\NotificationController@destroy')) {
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->addColumn([
                ...
                'visible' => auth()->user()?->hasAnyPermission(['App\Http\Controllers\NotificationController@destroy']),
