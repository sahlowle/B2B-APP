...
class ProductSettingController extends Controller
{
    ...
    {
        $response = $this->storeData($request->only('show_sold_by', 'is_publish_product', 'is_vendor_customer_list_active', 'vendor_category', 'system_suggestion', 'vendor_cat_commission', 'access_system_category', 'is_vendor_shop_decoration_active', 'vendor_phone'), 'product_vendor');
