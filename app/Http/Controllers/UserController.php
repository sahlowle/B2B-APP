...
class UserController extends Controller
{
    ...
    {
        $vendorIds = Role::getAll()->whereNotNull('vendor_id');
        $withoutRoles = ['vendor-admin', 'guest'];

        if ($vendorIds->count() < 1) {
            $withoutRoles[] = 'vendor-staff';
        }
        return view('admin.users.create', ['roles' => Role::getAll()->whereNotIn('slug', $withoutRoles)->whereNull('vendor_id')]);
    }
