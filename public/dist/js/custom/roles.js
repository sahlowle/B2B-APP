"use strict";
if ($('.main-body .page-wrapper').find('#role-add-container').length || $('.main-body .page-wrapper').find('#role-edit-container').length || $('.main-body .page-wrapper').find('#vendor-role-add-container').length || $('.main-body .page-wrapper').find('#vendor-role-edit-container').length) {
