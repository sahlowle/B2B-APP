...
$(document).on('click', '.add-to-cart', function() {
    ...
    } else if(itemType == 'Variable Product' && variationStatus == 'Out Of Stock') {
        Toast.fire({
            icon: 'error',
            title: jsLang('This product is out of stock.')
        })
...
$(document).on('click', '.buy-now-btn', function() {
    ...
    itemId = (itemType == 'Variable Product') ? variationId : itemId;
    if (itemType == 'Variable Product' && variationId == null) {
        Toast.fire({
            icon: 'error',
            title: jsLang('Please select some product options before adding this product to your cart.')
    ...
    } else if ((isManageStock == 1 && stockQty <= 0 && backOrders == 0) || stockStatus == 'Out Of Stock') {
        Toast.fire({
            icon: 'error',
            title: jsLang('Stock is not available.')
        })
