...
<div>
    ...
    <form method="POST" action="{{ route('password.resets') }}">
        ...
        <div class="input-group mb-4">
            <input type="password" class="form-control py-2" name="password" placeholder="{{ __('Password') }}">
        </div>
        
        <div class="input-group mb-4">
            <input type="password" class="form-control py-2" name="password_confirmation" placeholder="{{ __('Confirm password') }}">
        </div>
