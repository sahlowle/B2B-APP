                ...
                <div class="col-lg-9 col-12 ltr:ps-0 rtl:pe-0">
                    <div class="card card-info shadow-none mb-0">
                        ...
                        <div class="card-header p-t-20 border-bottom d-inline-block" id="smtp_head">
                            <h5>{{ __('Languages') }}</h5>
                            @hasPermission('App\Http\Controllers\LanguageController@store')
                                            ...
                                            @foreach ($languageList as $language)
                                                <tr>
                                                    ...
                                                    @hasAnyPermission([
                                                        ...
                                                        <td class="align-middle">
                                                            @hasPermission('App\Http\Controllers\LanguageController@translation')
                                                            ...
                                                            @hasPermission('App\Http\Controllers\LanguageController@edit')
                                                            ...
                                                            @if (auth()->user()?->hasPermission('App\Http\Controllers\LanguageController@delete') &&
