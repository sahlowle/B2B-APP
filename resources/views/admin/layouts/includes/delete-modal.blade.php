<div class="modal modal-blur fade" id="confirmDelete" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer bg-light">
          ...
          <button type="button" id="confirmDeleteSubmitBtn" data-task="" class="btn btn-danger">{{ __('Yes, Confirm') }}</button>
