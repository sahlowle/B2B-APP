<header class="navbar pcoded-header navbar-expand-lg navbar-light">
    ...
    <div class="collapse navbar-collapse">
        ...
        <ul class="navbar-nav nav-icon ltr:ms-lg-auto ltr:ms-2 ltr:me-lg-2 rtl:me-lg-auto rtl:me-2 rtl:ms-lg-2">
            ...
            @if (auth()->user()?->hasPermission('App\Http\Controllers\DashboardController@switchLanguage') && $languages->isNotEmpty())
                <li>
                    <div class="dropdown">
                ...
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        <div class="pro-head">
                            ...
                            @hasPermission('App\Http\Controllers\LoginController@logout')
