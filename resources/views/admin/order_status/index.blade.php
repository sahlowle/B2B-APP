                ...
                <div class="col-lg-9 ltr:ps-1 ltr:ps-lg-0 rtl:pe-1 rtl:pe-lg-0">
                    <div class="card card-info shadow-none mb-0">
                        ...
                        <div class="card-header p-t-20 border-bottom order-header" id="smtp_head">
                            <h5>{{ __('Status') }}</h5>
                            @hasPermission('App\Http\Controllers\OrderStatusController@store')
                                            ...
                                            @foreach ($orderStatuses as $status)
                                                <tr>
                                                    ...
                                                    @hasAnyPermission([
                                                        ...
                                                        <td>
                                                            @hasPermission('App\Http\Controllers\OrderStatusController@edit')
                                                            ...
                                                            @if (auth()->user()?->hasPermission('App\Http\Controllers\OrderStatusController@destroy') &&
                                                                    $status->is_default != 1 &&
