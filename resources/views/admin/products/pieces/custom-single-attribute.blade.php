    ...
    <div class="collapse show" id="{{ $unid }}">
        <div class="col-md-6 p-0">
            <div class="form-group mb-2 mr-2">
                ...
                <select name="attribute_types[{{ $idx }}]" class="form-control">
        ...
        <div class="row m-0 px-7 pb-30p">
                <div class="col-md-3 p-0">
                    ...
                    <div class="checkbox checkbox-primary d-inline p-0">
                        ...
                        <input type="checkbox" id="{{ $cid = uniqid() }}" value="1" name="attribute_visibilities[{{ $idx }}]">
                ...
                <div class="col-md-9 p-0-res attr">
                    <div class="dropdown-custom-attributes-{{$idx}}">
