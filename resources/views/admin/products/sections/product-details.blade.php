        ...
        <div class="card-body mt-20p px-3-res px-32p">
            <div class="form-group row">
                ...
                <div class="col-md-10 mt-1 description-color-div">
                    <textarea class="form-control rounded summernote" name="description">{{ isset($product) ? $product->getTranslated('description', request()->input('lang', config('app.locale'))) : '' }}</textarea>
                </div>
            </div>
            <div class="form-group row mt-20p">
                ...
                <div class="col-md-10 custom-details-form">
                    <textarea class="form-control" name="summary">{{ isset($product) ? $product->getTranslated('summary', request()->input('lang', config('app.locale'))) : '' }}</textarea>
                </div>
            </div>
        </div>
    </div>
