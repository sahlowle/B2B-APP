...
@section('content')
    ...
    <div class="col-sm-12" id="brand-edit-container">
        <div class="card">
            ...
            <div class="card-body mt-2 order-review-section pb-5">
                <div class="row mt-3 pt-4 reviews">
                    <div class="col-md-6 col-xl-4 mt-3 mt-md-0">
                        <img class="img-fluid review-img"
                            src="{{ optional($review->product)->getFeaturedImage('medium') }}">
                    </div>
                    <div class="col-md-6 col-xl-8 mt-3 mt-md-0 items">
                        <div class="ltr:text-md-start rtl:text-md-end">
                            <span>{{ __('Product') }}</span>
                            <h4 class="font-bold mt-2 item-name">
                                @isset($review->product->slug)
                                    <a target="_blank"
                                        href="{{ route('site.productDetails', ['slug' => $review->product->slug]) }}">{{ optional($review->product)->name }}</a>
                                @else
                        ...
                        <div class="ltr:text-md-start rtl:text-md-end mt-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ltr:ms-3 rtl:me-3">
                                    ...
                                    @if ($review->verifiedUser($review->user_id, $review->product_id) && preference('reviews_verified_owner_label') == 1)
                                        <div class="d-flex align-items-center">
                                            <span>
                        ...
                        <div class="ltr:text-md-start rtl:text-md-end mt-3">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xl-8 mt-3 mt-md-0">
                                        ...
                                        <div>
                                            ...
                                            <div class="d-flex flex-wrap">
                                                @foreach ($images as $key => $image)
                                                    <div class="m-1">
                                                        <a class="cursor_pointer" href='{{ $image }}'
                                                            data-lightbox="image-1">
                                                            <img class="img-fluid review-photo" src='{{ $image }}'
                                                                alt="{{ __('Image') }}">
                                                        </a>
                                                    </div>
                                                @endforeach
