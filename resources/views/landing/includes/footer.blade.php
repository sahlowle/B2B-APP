    <!-- Footer - LTR Version -->
    <footer class="footer bg-gray-900 text-white py-16" dir="ltr">
        <div class="container max-w-6xl mx-auto px-4">
            <div class="footer-content grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                <!-- Logo Section -->
                <div class="footer-section logo-section">
                    <div class="footer-logo flex flex-col items-start">
                        <img src="{{ asset("public/new-landing/img/image 1.svg") }}" alt="Exports Valley" class="h-12 md:h-16">
                    </div>
                </div>
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links list-none p-0 m-0 space-y-4">
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-gray-400 text-base">Saudi Arabia, Riyadh</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg class="w-5 h-5 text-orange-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                            </svg>
                            <a href="mailto:contact@exportsvalley.com" class="text-gray-400 text-base no-underline transition hover:text-orange-500">contact@exportsvalley.com</a>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg class="w-5 h-5 text-orange-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                            </svg>
                            <a href="tel:+966500066496" class="text-gray-400 text-base no-underline transition hover:text-orange-500">+966500066496</a>
                        </li>
                    </ul>
                </div>
            </div>
            
            <div class="footer-divider border-t border-gray-700 my-8"></div>
            ...
            <div class="footer-bottom flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <p class="copyright text-gray-400 text-base text-center md:text-left m-0">© 2025 Exports Valley. All rights reserved.</p>
            </div>
        </div>
    </footer>

    <!-- Footer - RTL Version -->
    <footer class="footer rtl bg-gray-900 text-white py-16 hidden" dir="rtl">
        <div class="container max-w-6xl mx-auto px-4">
            <div class="footer-content grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                
                <div class="footer-section logo-section md:col-span-2 lg:col-span-1">
                    <div class="footer-logo flex flex-col items-start">
                        <img src="{{ asset("public/new-landing/img/image 1.svg") }}" alt="Exports Valley" class="h-12 md:h-16 mb-6">
                    </div>
                </div>
                ...
                <!-- Contact Us -->
                <div class="footer-section">
                    <h3 class="footer-title text-xl font-semibold mb-6 text-white text-right">تواصل معنا</h3>
                    <ul class="footer-links list-none p-0 m-0 space-y-4">
                        <li class="flex items-start gap-3">
                            <svg class="w-5 h-5 text-orange-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                            ...
                            <span class="text-gray-400 text-base text-right">المملكة العربية السعودية، الرياض</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg class="w-5 h-5 text-orange-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                            </svg>
                            <a href="mailto:contact@exportsvalley.com" class="text-gray-400 text-base no-underline transition hover:text-orange-500 text-right">contact@exportsvalley.com</a>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg class="w-5 h-5 text-orange-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                            </svg>
                            <a href="tel:+966500066496" class="text-gray-400 text-base no-underline transition hover:text-orange-500 text-right">+966500066496</a>
                        </li>
                    </ul>
                </div>
            </div>
