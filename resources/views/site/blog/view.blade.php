                ...
                <div class="md:w-4/6 lg:w-full ltr:md:mr-8 rtl:md:ml-8">
                    ...
                    <div>
                        <div class="left-side lg:w-833 w-full h-411p">
                            <img src="{{ $blog->fileUrl() }}" class="rounded w-full lg:h-411p h-full object-cover"/>
                        </div>
                    ...
                    @if (isset($blog->user) && !empty($blog->user))
                        <div class="lg:w-833 w-full lg:h-152 border rounded border-gray-2 box-border">
                            <div class="grid lg:grid-cols-4 grid-cols-2">
                                <img class="h-24 w-24 my-7 object-fit rounded-full ltr:ml-7 rtl:mr-7" src="{{ optional($blog->user)->fileUrl() }}"
                                    alt="{{ __('Image') }}">
                                    ...
                                    <div class="flex mt-3.5 cursor-pointer text-gray-10">
                                        @if (optional($blog->user)->facebook)
                                            <a href="{{ optional($blog->user)->facebook }}">
                                                <svg class="hover:text-gray-12 transition ease-in-out delay-130 ltr:mr-3 rtl:ml-3 "
                                        ...
                                        @if (optional($blog->user)->instagram)
                                            <a href="{{ optional($blog->user)->twitter }}">
                                                <svg class="t-0.5 hover:text-gray-12 transition ease-in-out delay-130 ltr:mr-3 rtl:ml-3"
                        ...
                        <div class="flex">
                            ...
                            <div class="flex text-gray-10 ltr:mr-1 rtl:ml-1">
                                ...
                                <a href="https://www.facebook.com/sharer.php?u={{ urlencode(url()->current()) }}"
                                    target="_blank">
                                    <svg class="transition ease-in-out delay-130 hover:text-gray-12 hover:border-gray-12 border border-gray-2 rounded-full cursor-pointer ltr:mr-7p rtl:ml-7p"
                                ...
                                <a href="https://api.whatsapp.com/send?text={{ urlencode(url()->current()) }}"
                                    target="_blank">
                                    <svg class="hover:text-gray-12 transition ease-in-out delay-130 hover:border-gray-12 border border-gray-2 rounded-full cursor-pointer ltr:mr-7p rtl:ml-7p"
                                        xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                        viewBox="0 0 25 25" fill="none">
                                ...
                                <div class="relative w-full md:w-1/3 sm:mb-0 mb-6">
                                    <a href="{{ route('blog.details', $relatedPost->slug) }}">
                                        <div class="w-245p md:w-full">
                                            <img alt="content" class="rounded h-141p w-275p object-fit"
