...
@section('content')
    @php
        ...
        foreach ($cartsValue as $key => $val) {
            ...
            $product = App\Models\Product::select('id', 'slug', 'name', 'available_from', 'available_to', 'status', 'manage_stocks', 'total_stocks', 'shop_id', 'sale_to', 'sale_price', 'regular_price', 'type', 'parent_id', 'vendor_id')->where('id', $val['id'])->with('parentDetail:id,vendor_id')->first();
