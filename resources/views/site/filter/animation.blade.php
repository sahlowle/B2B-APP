<div class="flex">
    @if (preference('filter_show_category', true) && preference('filter_show_price_range', true) && preference('filter_show_attribute', true) && preference('filter_show_brand', true) && preference('filter_show_rating', true))
