        ...
        <div class="border-b pb-4">
            <div>
                <a class="flex title-font font-medium items-center md:justify-start text-gray-900 mt-18p">
                   ...
                   @php
                           $shippingDetails = preference('hide_shipping_cost') == 1 && empty($defaultAddresses) ? null : \App\Models\Product::getMaxShipping($id);
                  @endphp
                    <div class="flex justify-between items-center w-full">
                        ...
                        <p class="font-bold dm-bold text-gray-12 text-15" id="shippingAmount"> {{ isset($shippingDetails['amount']) ? multiCurrencyFormatNumber($shippingDetails['amount']) : multiCurrencyFormatNumber(0) }} </p>
                    </div>
                </a>
