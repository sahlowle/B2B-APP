                ...
                <div class="md:w-2/3 w-28 flex items-center">
                    <div class="item-rating">
                        ...
                        <div class="flex gap-x-2">
                            ...
                            @endif
                            @if($item->isVariableProduct() ? false : $item->isShowStockQuantity())
                                <p class="primary-bg-color z-30 relative py-1 text-gray-12 w-14 break-all justify-center mb-1 flex items-center rounded-sm leading-3 px-1.5 roboto-medium font-medium text-8">{{ __(':x left', ['x' => $item->getStockQuantity()]) }}</p>
                            @endif
                        </div>
                        <div class="-mt-1">
