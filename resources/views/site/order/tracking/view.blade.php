...
@section('content')
@php
    $order = \App\Models\Order::with(\App\Services\Actions\Facades\OrderActionFacade::relationsWith())
        ...
        ->first();
    $statuses = \App\Models\OrderStatus::select('id', 'name')->orderBy('order_by')->get();
@endphp
