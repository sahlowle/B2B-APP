        ...
        <div class="max-w-4xl mx-auto">
            ...
            <section class="mb-12">
                <div class="bg-white rounded-lg shadow-lg p-8">
                    ...
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        <p class="mb-6">
                            إكسبورتس فالي هي منصة رقمية متخصصة في مجال التجارة بين الشركات (B2B) مقرها مدينة الرياض في المملكة العربية السعودية. تعمل المنصة على ربط المصانع السعودية بالمشترين العالميين عبر واجهات إلكترونية مخصصة وخوارزميات ذكاء اصطناعي متقدمة للتوفيق بين المنتجات السعودية واحتياجات المشترين حول العالم.
                        </p>
                        <p class="mb-6">
                            كما توفر إكسبورتس فالي أدوات تسويق رقمي مبتكرة ودعمًا متكاملًا للخدمات اللوجستية وعمليات التصدير، مما يُسهّل على المصنّعين المحليين الوصول إلى الأسواق الدولية بسرعة وسلاسة. وتتيح المنصة للمصانع عرض منتجاتها والتواصل المباشر مع المشترين وإبرام الصفقات بسهولة وشفافية عبر بيئة إلكترونية موثوقة وآمنة.
                        </p>
                        <p class="mb-6">
                            تركّز إكسبورتس فالي على توطين الحلول الرقمية للصناعة السعودية، حيث تم تصميم منصتنا خصيصًا لتلبية احتياجات القطاع الصناعي الوطني باللغة العربية وعدة لغات عالمية لتسهل على المستوردين من حول العالم التواصل وبما يتوافق مع متطلبات السوق المحلية.
                        </p>
                        <p>
                            وبالاعتماد على أحدث تقنيات الذكاء الاصطناعي والتحول الرقمي، نسعى إلى تعزيز القدرة التنافسية للمصانع السعودية وتمكينها من التوسع عالميًا. وفي ظل رؤية المملكة 2030 التي تهدف إلى تنويع الاقتصاد وزيادة الصادرات غير النفطية، تلتزم إكسبورتس فالي بلعب دور فعّال في دعم هذه الرؤية عبر تمكين الصناعات الوطنية بأدوات رقمية مبتكرة ومتكاملة تضمن الكفاءة والشفافية في جميع مراحل عملية التصدير.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <div class="grid md:grid-cols-2 gap-8 mb-12">
                ...
                <section class="bg-white rounded-lg shadow-lg p-8">
                    ...
                    <p class="text-gray-700 leading-relaxed text-center">
                        رسالتنا هي تمكين المصانع السعودية من الوصول إلى الأسواق العالمية بسهولة وشفافية عبر منصة رقمية متكاملة. نوفر حلولًا رقمية محلية مبتكرة ومدعومة بالذكاء الاصطناعي لتبسيط عمليات التواصل والتفاوض والتعاقد، وتعزيز كفاءة التسويق والتصدير بما يدعم النمو المستدام للقطاع الصناعي الوطني ويتوافق مع مستهدفات رؤية المملكة 2030.
                    </p>
                </section>
                ...
                <section class="bg-white rounded-lg shadow-lg p-8">
                    ...
                    <p class="text-gray-700 leading-relaxed text-center">
                        رؤيتنا هي أن نكون المنصة الرائدة للتصدير الرقمي في المملكة العربية السعودية، من خلال ريادة الابتكار التقني واعتماد تقنيات الذكاء الاصطناعي في ربط المنتجات السعودية بالأسواق العالمية بمرونة وكفاءة عالية. نسعى إلى ترسيخ مكانة المملكة كمركز صناعي عالمي رائد عبر تمكين الشركات والمصانع الوطنية بأفضل الحلول الرقمية، والمساهمة في زيادة نسبة الصادرات غير النفطية وتحقيق التنمية الاقتصادية المستدامة.
                    </p>
                </section>
            </div>
            ...
            <section class="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-8 text-center">
                ...
                <p class="text-gray-700 leading-relaxed max-w-3xl mx-auto">
                    نحن نؤمن بأن الابتكار التقني والتحول الرقمي هما مفتاح ازدهار القطاع الصناعي السعودي عالميًا، لذا نحرص على توفير منصة موثوقة ترتقي بتجربة التصدير وتساهم في ترسيخ مكانة المملكة كمركز صناعي عالمي.
                </p>
            </section>
        </div>
