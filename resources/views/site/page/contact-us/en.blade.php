        ...
        <div class="py-12 bg-gradient-to-r from-blue-50 to-indigo-100 rounded-lg mb-8">
            <div class="text-center">
                ...
                <p class="text-lg text-gray-600 max-w-3xl mx-auto px-4">
                    {{ __('Get in touch with our team. We\'re here to help you with any questions or support you need.') }}
                </p>
            </div>
        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">
                                    {{ __('Riyadh, Saudi Arabia') }}<br>
                                    {{ __('King Fahd Road, Business District') }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">
                                    {{ __('Sunday - Thursday: 9:00 AM - 6:00 PM') }}<br>
                                    {{ __('Friday - Saturday: Closed') }}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mt-12 bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg p-8">
                <div class="text-center">
                    ...
                    <p class="text-gray-700 mb-6">
                        {{ __('For urgent matters or immediate support, please call us directly or use our live chat feature available on the website.') }}
                    </p>
