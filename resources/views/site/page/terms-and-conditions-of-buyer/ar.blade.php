...
@section('page_title', 'الشروط والأحكام للمشتري')

@section('seo')
    <meta name="robots" content="index, follow">
    <meta name="title" content="الشروط والأحكام للمشتري - إكسبورتس فالي">
    <meta name="description" content="الشروط والأحكام الخاصة بالمشترين في منصة إكسبورتس فالي - منصة التجارة الرقمية بين الشركات" />
    <meta name="keywords" content="شروط المشتري, أحكام المشتري, إكسبورتس فالي, منصة التجارة, B2B">

    <!-- Schema.org markup for Google+ -->
    <meta itemprop="name" content="الشروط والأحكام للمشتري - إكسبورتس فالي">
    <meta itemprop="description" content="الشروط والأحكام الخاصة بالمشترين في منصة إكسبورتس فالي - منصة التجارة الرقمية بين الشركات">
    <meta itemprop="image" content="{{ asset('images/logo.png') }}">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="الشروط والأحكام للمشتري - إكسبورتس فالي">
    <meta property="og:description" content="الشروط والأحكام الخاصة بالمشترين في منصة إكسبورتس فالي - منصة التجارة الرقمية بين الشركات">
    <meta property="og:image" content="{{ asset('images/logo.png') }}">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{ url()->current() }}">
    <meta property="twitter:title" content="الشروط والأحكام للمشتري - إكسبورتس فالي">
    <meta property="twitter:description" content="الشروط والأحكام الخاصة بالمشترين في منصة إكسبورتس فالي - منصة التجارة الرقمية بين الشركات">
            ...
            <nav class="text-gray-600 text-sm" aria-label="Breadcrumb">
                <ol class="list-none p-0 flex flex-wrap md:inline-flex text-xs md:text-sm roboto-medium font-medium text-gray-10 leading-5">
                    ...
                    <li class="flex items-center text-gray-12">
                        <a href="javascript: void(0)">الشروط والأحكام للمشتري</a>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-8 text-center">
                    الشروط والأحكام الخاصة بالمشتري
                </h1>
...
تُعد منصة اكسبورتس فالي (شركة سعودية مقرها الرياض) منصة رقمية مبتكرة تعمل كوسيط تقني يربط بين المصانع السعودية (المصدرين) والمشترين الدوليين. المنصة لا تمارس أي دور في عمليات البيع أو الشراء المباشر ولا تتدخل في صياغة العقود أو تحصيل المدفوعات أو تحديد شروط التوريد، وإنما تقدم خدمات رقمية لتسهيل عملية التواصل والربط التجاري.
                    </p>
                    <p class="text-gray-700 leading-relaxed">
باستخدامك للمنصة بصفة "مشتري/مستورد"، فإنك توافق على الالتزام الكامل بهذه الشروط والأحكام وسياسة الخصوصية ذات الصلة، ويُعتبر استمرارك في استخدام المنصة إقرارًا منك بقبولها.
                    </p>
                </div>
            </div>
...
المادة الأولى: التعريفات
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <p class="text-gray-700"><strong>المستخدم/أنت:</strong> يقصد بها أي شخص يستخدم المنصة بصفته مشتريًا أو بائعًا أو زائرًا.</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <p class="text-gray-700"><strong>المشتري/المستورد:</strong> يقصد به أي شخص أو شركة أو مؤسسة تجارية تقوم بالتسجيل في المنصة للتواصل مع البائعين والمصانع السعودية بهدف شراء منتجاتهم.</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <p class="text-gray-700"><strong>البائع/المُصنّع:</strong> يقصد به المصنع أو الشركة السعودية التي تعرض منتجاتها عبر المنصة للتواصل مع المشترين.</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-6 border-b border-gray-200 pb-3">
المادة الثانية: شروط التسجيل للمشتري
                </h2>
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">يشترط أن يكون المشتري ذا أهلية نظامية وقانونية وفقًا للأنظمة المعمول بها في بلده.</p>
                    </div>
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">يلتزم المشتري بتقديم بيانات صحيحة وكاملة أثناء التسجيل، ويكون مسؤولًا وحده عن تحديثها عند حدوث أي تغيير.</p>
                    </div>
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">يقر المشتري بأن حسابه شخصي أو تابع لكيانه التجاري، ويتحمل كامل المسؤولية عن أي استخدام يتم عبره.</p>
                    </div>
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">تحتفظ المنصة بحق رفض أو تعليق أو حذف أي حساب لا يلتزم بهذه الشروط.</p>
                    </div>
                </div>
            </div>
...
المادة الثالثة: طبيعة عمل المنصة وإخلاء المسؤولية
                ...
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">دور المنصة يقتصر على التوفيق التقني والوساطة الرقمية بين البائع والمشتري، ولا تُعتبر طرفًا في أي عقد بيع أو اتفاقية توريد.</p>
                    </div>
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">جميع التفاهمات والشروط التجارية (مثل الأسعار، الكميات، جودة المنتجات، مواعيد الشحن، وسائل الدفع) تتم مباشرة بين البائع والمشتري.</p>
                    </div>
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">تُخلي المنصة مسؤوليتها عن:</p>
                    </div>
                    <div class="ml-12 space-y-2">
                        <div class="flex items-start">
                            <span class="flex-shrink-0 w-2 h-2 bg-orange-400 rounded-full mt-2 mr-3"></span>
                            <p class="text-gray-700 leading-relaxed">أي نزاع أو تقصير في تنفيذ الالتزامات التعاقدية.</p>
                        </div>
                        <div class="flex items-start">
                            <span class="flex-shrink-0 w-2 h-2 bg-orange-400 rounded-full mt-2 mr-3"></span>
                            <p class="text-gray-700 leading-relaxed">جودة أو مطابقة المنتجات للمواصفات.</p>
                        </div>
                        <div class="flex items-start">
                            <span class="flex-shrink-0 w-2 h-2 bg-orange-400 rounded-full mt-2 mr-3"></span>
                            <p class="text-gray-700 leading-relaxed">أي أضرار أو خسائر مالية أو مادية أو معنوية تنشأ عن التعامل بين المستخدمين.</p>
                        </div>
                    </div>
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">في حال حدوث نزاع، يكون اللجوء إلى الحل المباشر بين البائع والمشتري أو إلى الجهات القضائية المختصة.</p>
                    </div>
                </div>
            </div>
...
المادة الرابعة: حقوق المنصة
                ...
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">تحتفظ المنصة بحقها في تعديل أو حذف أو تعطيل أي محتوى أو حساب يخالف الأنظمة أو يسيء لاستخدام المنصة.</p>
                    </div>
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">يحق للمنصة إيقاف أو تعديل الخدمات الرقمية المقدمة دون إشعار مسبق.</p>
                    </div>
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">قد تزود المنصة الجهات الرسمية بالمعلومات اللازمة إذا طُلب منها ذلك بموجب القانون.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-6 border-b border-gray-200 pb-3">
المادة الخامسة: التزامات المشتري
                </h2>
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">يلتزم المشتري باستخدام المنصة فقط للأغراض التجارية المشروعة وعدم استغلالها لأي أنشطة غير قانونية.</p>
                    </div>
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">يتحمل المشتري مسؤولية التحقق من دقة وصحة المعلومات المقدمة من البائع قبل الدخول في أي تعامل تجاري.</p>
                    </div>
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">أي التزامات مالية أو قانونية أو تجارية ناتجة عن الاتفاق مع البائع تقع على المشتري وحده.</p>
                    </div>
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">يلتزم المشتري بالامتثال للأنظمة المعمول بها في بلده والمتعلقة بالاستيراد والجمارك والضرائب.</p>
                    </div>
                </div>
            </div>
...
المادة السادسة: الأطراف الثالثة
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    <p class="text-gray-700 leading-relaxed">قد تستعين المنصة بمزودي خدمات تقنيين (مثل استضافة البيانات أو التحليلات أو التسويق). لا تتحمل المنصة أي مسؤولية عن أية أخطاء أو إخفاقات من هذه الجهات، وعلى المستخدم مراجعة سياساتهم الخاصة بشكل مستقل.</p>
                </div>
            </div>
...
المادة السابعة: الملكية الفكرية
                ...
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">جميع حقوق المنصة بما في ذلك الاسم والشعار والتصاميم والبرمجيات وقواعد البيانات مملوكة حصريًا لشركة اكسبورتس فالي.</p>
                    </div>
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">لا يحق للمشتري نسخ أو إعادة استخدام أي جزء من محتويات المنصة دون إذن خطي مسبق.</p>
                    </div>
                </div>
            </div>
...
المادة الثامنة: القانون واجب التطبيق
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    <p class="text-gray-700 leading-relaxed">تخضع هذه الاتفاقية لأنظمة المملكة العربية السعودية، ويُحال أي نزاع ينشأ عنها إلى الجهات القضائية المختصة بالمملكة.</p>
                </div>
            </div>
...
المادة التاسعة: أحكام عامة
                ...
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">يحق للمنصة تعديل هذه الشروط من وقت لآخر، ويُعتبر استمرار استخدامك للمنصة بعد التعديلات موافقة ضمنية منك عليها.</p>
                    </div>
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">في حال تعارض النص العربي مع أي ترجمة، يُعتمد النص العربي.</p>
                    </div>
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-700 leading-relaxed">استمرارك في استخدام المنصة يعني قبولك الكامل بجميع البنود الواردة هنا.</p>
                    </div>
                </div>
            </div>
        </div>
